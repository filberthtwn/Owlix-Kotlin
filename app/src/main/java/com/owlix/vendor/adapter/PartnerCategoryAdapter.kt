...
class PartnerCategoryAdapter(private val context: Activity, private var data: List<PartnerCategoryData>): ArrayAdapter<PartnerCategoryData>(context, R.layout.item_text_list, data) {

//    fun updateData(data: List<PartnerCategoryData>) {
//        this.data = data
