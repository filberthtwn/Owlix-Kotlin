...
class TermsConditionFragment : Fragment() {
    ...
    private fun setupViews(){
        tb_owlix.tv_tb_title.text = "Syarat dan Ketentuan"
        ...
        wv_privacy_policy.webViewClient = object : WebViewClient(){
            override fun shouldOverrideUrlLoading(
                ...
                view?.loadUrl("https://production.owlix-id.com/html/TermsAndCondition.html")
                return super.shouldOverrideUrlLoading(view, request)
            }
        }
        wv_privacy_policy.loadUrl("https://production.owlix-id.com/html/TermsAndCondition.html")
    }
}