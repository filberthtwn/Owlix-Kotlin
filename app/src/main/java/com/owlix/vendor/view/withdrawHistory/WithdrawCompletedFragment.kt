...
class WithdrawCompletedFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_withdraw_completed, container, false)
    }
    ...
    private fun setupViews(){
        ...
        rv_withdraw_completed.adapter = adapter
        rv_withdraw_completed.layoutManager = LinearLayoutManager(this.requireContext(), LinearLayoutManager.VERTICAL, false)
        rv_withdraw_completed.setHasFixedSize(true)
    }

    private fun setupData(){
        this.loadingDialog = LoadingDialog(childFragmentManager)
        this.loadingDialog!!.startLoading()
        this.userVM.getAllWithdraw(Status.Withdraw.COMPLETED)
    }
